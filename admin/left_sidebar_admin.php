    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    <a class="has-arrow  " href="javascript:void(0)" aria-expanded="false"><i class="fa fa-gamepad"></i><span class="hide-menu">Games</span></a>
                    <ul aria-expanded="false" class="collapse">
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <?php if ($sidebarRole !== 'admin') { ?>
                        <li><a href="../dashboard/trader_request.php">Become Trader</a></li>
                        <?php } ?>
                        <?php if ($sidebarRole === 'admin') { ?>
                        <!-- <li><a href="../dashboard/trader_requests.php">Trader Requests</a></li> -->
                        ...
                        <li><a href="../dashboard/selling_packages.php">Selling Packages</a></li>
                        <li><a href="../dashboard/converter_packages.php">Converter Packages</a></li>
