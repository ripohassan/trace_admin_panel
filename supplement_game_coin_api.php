 ...
 * Difference from update_game_coin_api: no type and no token required.
 * Coins are always added (type=2 obtain).
 *
 * Note: Replenishment is polled once every 1-5 minutes on average.
 * If your company considers security, you can store the records in database
 * after receiving data and return success. Then manually reissue to user
 * after background review.
 *
 * Request Body (JSON):
 * {
 *   "orderId": "abcefg12345",
...
// ── 7. Calculate new coin balance (always add/obtain) ────────────────────
