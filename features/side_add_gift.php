                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input id="val-file" name="val-file" type="file" accept="application/json,image/png,image/jpeg,image/webp,image/gif,image/svg+xml,.svga,.svg" required />
                                    <div class="invalid-feedback">Please choose a JSON, image, SVG, or SVGA file for this gift.</div>
                                    <div class="valid-feedback">Looks good!</div>
                                </div>
                            </div>
